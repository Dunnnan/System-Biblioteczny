...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(352354181423138738)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352354460563138741)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352354740181138752)
,p_plugin_attribute_id=>wwv_flow_imp.id(352354460563138741)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352355110952138753)
,p_plugin_attribute_id=>wwv_flow_imp.id(352354460563138741)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352355511749138754)
,p_plugin_attribute_id=>wwv_flow_imp.id(352354460563138741)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352355992637138754)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352354460563138741)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352356231102138754)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352356515124138755)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352356812200138755)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352357198703138755)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352357411922138756)
,p_plugin_attribute_id=>wwv_flow_imp.id(352357198703138755)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352357808884138756)
,p_plugin_attribute_id=>wwv_flow_imp.id(352357198703138755)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352358271991138757)
,p_plugin_attribute_id=>wwv_flow_imp.id(352357198703138755)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352358602430138757)
,p_plugin_attribute_id=>wwv_flow_imp.id(352357198703138755)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352359028814138757)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352359350990138758)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352359711183138758)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352360172912138758)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352360597180138759)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352360987466138759)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352361303387138760)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352361745526138760)
,p_plugin_attribute_id=>wwv_flow_imp.id(352359028814138757)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352362129349138760)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2152404979064252492)
,p_plugin_id=>wwv_flow_imp.id(352354181423138738)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
