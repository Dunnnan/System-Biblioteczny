...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(352363222887138763)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352363500518138765)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352363884745138765)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352364176895138765)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352364431612138766)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352364736294138766)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352365047565138766)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352365341531138767)
,p_plugin_attribute_id=>wwv_flow_imp.id(352365047565138766)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352365797285138767)
,p_plugin_attribute_id=>wwv_flow_imp.id(352365047565138766)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352366140971138768)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352366404055138768)
,p_plugin_attribute_id=>wwv_flow_imp.id(352366140971138768)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352366869523138768)
,p_plugin_attribute_id=>wwv_flow_imp.id(352366140971138768)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352367292346138769)
,p_plugin_attribute_id=>wwv_flow_imp.id(352366140971138768)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352367656540138769)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352367965011138769)
,p_plugin_attribute_id=>wwv_flow_imp.id(352367656540138769)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352368335397138770)
,p_plugin_attribute_id=>wwv_flow_imp.id(352367656540138769)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352368709867138770)
,p_plugin_attribute_id=>wwv_flow_imp.id(352367656540138769)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1863845482520240953)
,p_plugin_id=>wwv_flow_imp.id(352363222887138763)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
