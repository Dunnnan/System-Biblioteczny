...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(352372006571138776)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2152257561999170494)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352372550154138780)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352372817823138780)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352373195950138781)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352373417825138781)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352373755700138781)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352378378196138787)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2152257561999170494)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352374023723138782)
,p_plugin_attribute_id=>wwv_flow_imp.id(352373755700138781)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352374451896138782)
,p_plugin_attribute_id=>wwv_flow_imp.id(352373755700138781)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352374833115138783)
,p_plugin_attribute_id=>wwv_flow_imp.id(352373755700138781)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352375284827138783)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352373755700138781)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352375566966138783)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352375884951138784)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352376180309138784)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352376494652138784)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352376722741138785)
,p_plugin_attribute_id=>wwv_flow_imp.id(352376494652138784)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352377161618138785)
,p_plugin_attribute_id=>wwv_flow_imp.id(352376494652138784)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352377529272138786)
,p_plugin_attribute_id=>wwv_flow_imp.id(352376494652138784)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352377938401138786)
,p_plugin_attribute_id=>wwv_flow_imp.id(352376494652138784)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352378378196138787)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352378674180138787)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352378984793138787)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352379224815138788)
,p_plugin_attribute_id=>wwv_flow_imp.id(352378984793138787)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352379658040138788)
,p_plugin_attribute_id=>wwv_flow_imp.id(352378984793138787)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352380077686138788)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2152390229432271997)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2152389637927264540)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2152445261597246419)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2152597479310117190)
,p_plugin_id=>wwv_flow_imp.id(352372006571138776)
