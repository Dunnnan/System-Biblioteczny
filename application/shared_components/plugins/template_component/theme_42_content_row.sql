...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(352382141990138794)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2279619980938210494)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2279619425926210493)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2022727362195936980)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352383019171138801)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352383389365138801)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352383634755138801)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352383958751138802)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352384218567138802)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352384512240138802)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352384869071138803)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352384218567138802)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2279619980938210494)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352385117952138803)
,p_plugin_attribute_id=>wwv_flow_imp.id(352384869071138803)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352385577766138804)
,p_plugin_attribute_id=>wwv_flow_imp.id(352384869071138803)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352385942383138804)
,p_plugin_attribute_id=>wwv_flow_imp.id(352384869071138803)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352386329783138805)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352384869071138803)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352386644813138805)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352386963219138805)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352387269529138806)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352387522621138806)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352387891917138807)
,p_plugin_attribute_id=>wwv_flow_imp.id(352387522621138806)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352388262520138807)
,p_plugin_attribute_id=>wwv_flow_imp.id(352387522621138806)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352388669440138807)
,p_plugin_attribute_id=>wwv_flow_imp.id(352387522621138806)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352389079188138808)
,p_plugin_attribute_id=>wwv_flow_imp.id(352387522621138806)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352389471379138808)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(352384512240138802)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2279619425926210493)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352389710753138809)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352390066902138809)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352390363767138809)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352390651223138810)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352390989835138810)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352391217754138811)
,p_plugin_attribute_id=>wwv_flow_imp.id(352390989835138810)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352391685910138811)
,p_plugin_attribute_id=>wwv_flow_imp.id(352390989835138810)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352392064743138812)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352392395700138812)
,p_plugin_attribute_id=>wwv_flow_imp.id(352392064743138812)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352392761664138812)
,p_plugin_attribute_id=>wwv_flow_imp.id(352392064743138812)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352393194663138813)
,p_plugin_attribute_id=>wwv_flow_imp.id(352392064743138812)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352393518896138813)
,p_plugin_attribute_id=>wwv_flow_imp.id(352392064743138812)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352393944919138814)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352394288512138814)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352394677876138815)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352395018902138815)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352395434328138815)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352395848945138816)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352396271413138816)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352396603160138817)
,p_plugin_attribute_id=>wwv_flow_imp.id(352393944919138814)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352397096515138817)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352397331980138818)
,p_plugin_attribute_id=>wwv_flow_imp.id(352397096515138817)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352397710737138818)
,p_plugin_attribute_id=>wwv_flow_imp.id(352397096515138817)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352398153886138819)
,p_plugin_attribute_id=>wwv_flow_imp.id(352397096515138817)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352398531094138819)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352398897980138819)
,p_plugin_attribute_id=>wwv_flow_imp.id(352398531094138819)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352399216107138820)
,p_plugin_attribute_id=>wwv_flow_imp.id(352398531094138819)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352399673513138820)
,p_plugin_attribute_id=>wwv_flow_imp.id(352398531094138819)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352400013819138821)
,p_plugin_attribute_id=>wwv_flow_imp.id(352398531094138819)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352400404689138821)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352400766822138822)
,p_plugin_attribute_id=>wwv_flow_imp.id(352400404689138821)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352401170223138822)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352401494720138822)
,p_plugin_attribute_id=>wwv_flow_imp.id(352401170223138822)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352401830798138823)
,p_plugin_attribute_id=>wwv_flow_imp.id(352401170223138822)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352402297569138823)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352402530523138824)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352402803496138824)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(2022727362195936980)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352403118661138825)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352403424043138825)
,p_plugin_attribute_id=>wwv_flow_imp.id(352403118661138825)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352403814679138826)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352404110238138826)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2160833871154032108)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2160835130674036256)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1863882356258273678)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2147240242479625375)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2147919543209708479)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2160831936086987122)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2160833269477000979)
,p_plugin_id=>wwv_flow_imp.id(352382141990138794)
