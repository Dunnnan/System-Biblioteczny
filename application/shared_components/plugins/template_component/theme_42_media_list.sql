...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(352409571694138838)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2152427974146022490)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2152427419134022489)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352410248324138842)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352410593981138843)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352410809483138843)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352411118936138843)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352411466388138844)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352410809483138843)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2152427974146022490)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352411702104138844)
,p_plugin_attribute_id=>wwv_flow_imp.id(352411466388138844)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352412116493138845)
,p_plugin_attribute_id=>wwv_flow_imp.id(352411466388138844)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352412599483138845)
,p_plugin_attribute_id=>wwv_flow_imp.id(352411466388138844)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352412914989138845)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(352411466388138844)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352413295008138846)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352413505193138846)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352413868718138847)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352414171939138847)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352414496982138847)
,p_plugin_attribute_id=>wwv_flow_imp.id(352414171939138847)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352414838339138848)
,p_plugin_attribute_id=>wwv_flow_imp.id(352414171939138847)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352415290709138848)
,p_plugin_attribute_id=>wwv_flow_imp.id(352414171939138847)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352415672414138849)
,p_plugin_attribute_id=>wwv_flow_imp.id(352414171939138847)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352416096344138849)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(352411118936138843)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2152427419134022489)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352416330938138850)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352416660481138850)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352416957359138850)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352417287607138851)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352417548396138851)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352417866744138851)
,p_plugin_attribute_id=>wwv_flow_imp.id(352417548396138851)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352418234869138852)
,p_plugin_attribute_id=>wwv_flow_imp.id(352417548396138851)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352418668732138852)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352418959551138853)
,p_plugin_attribute_id=>wwv_flow_imp.id(352418668732138852)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352419392861138853)
,p_plugin_attribute_id=>wwv_flow_imp.id(352418668732138852)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352419710909138854)
,p_plugin_attribute_id=>wwv_flow_imp.id(352418668732138852)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352420167388138854)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352420418582138854)
,p_plugin_attribute_id=>wwv_flow_imp.id(352420167388138854)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352420847050138855)
,p_plugin_attribute_id=>wwv_flow_imp.id(352420167388138854)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352421204016138855)
,p_plugin_attribute_id=>wwv_flow_imp.id(352420167388138854)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352421638873138856)
,p_plugin_attribute_id=>wwv_flow_imp.id(352420167388138854)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352422033027138856)
,p_plugin_attribute_id=>wwv_flow_imp.id(352420167388138854)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352422427752138857)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(352422785921138857)
,p_plugin_attribute_id=>wwv_flow_imp.id(352422427752138857)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(352423160082138857)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2152631026303169118)
,p_plugin_id=>wwv_flow_imp.id(352409571694138838)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
