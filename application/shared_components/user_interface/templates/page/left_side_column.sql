...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(352178933108138592)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352179287049138592)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352179592141138593)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352179896697138593)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352180141350138593)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352180427834138593)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352180777877138593)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352181074478138594)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352181315277138594)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352181634453138594)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352181973831138594)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352182294370138594)
,p_page_template_id=>wwv_flow_imp.id(352178933108138592)
