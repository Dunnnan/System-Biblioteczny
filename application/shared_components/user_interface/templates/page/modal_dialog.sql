...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(352196603089138616)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352196935857138616)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352197211273138617)
,p_page_template_id=>wwv_flow_imp.id(352196603089138616)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352197537424138617)
,p_page_template_id=>wwv_flow_imp.id(352196603089138616)
