...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(352198139087138617)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352198496057138618)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352198708316138618)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352199078816138618)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352199311798138618)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352199678493138618)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352199972003138619)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352200251768138619)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352200513855138619)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352200812737138619)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352201186139138619)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352201426558138620)
,p_page_template_id=>wwv_flow_imp.id(352198139087138617)
