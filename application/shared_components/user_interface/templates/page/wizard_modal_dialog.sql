...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(352205231645138622)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352205511027138623)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352205800033138623)
,p_page_template_id=>wwv_flow_imp.id(352205231645138622)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352206163102138623)
,p_page_template_id=>wwv_flow_imp.id(352205231645138622)
