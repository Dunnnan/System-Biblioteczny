...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352211954188138628)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352212213325138628)
,p_plug_template_id=>wwv_flow_imp.id(352211954188138628)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352212544024138629)
,p_plug_template_id=>wwv_flow_imp.id(352211954188138628)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352212807855138629)
,p_plug_template_id=>wwv_flow_imp.id(352211954188138628)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352213191611138629)
,p_plug_template_id=>wwv_flow_imp.id(352211954188138628)
,p_name=>'Sub Regions'
