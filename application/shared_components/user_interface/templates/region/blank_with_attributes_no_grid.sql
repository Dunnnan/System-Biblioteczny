...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352213310244138629)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352213607759138629)
,p_plug_template_id=>wwv_flow_imp.id(352213310244138629)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352213941702138630)
,p_plug_template_id=>wwv_flow_imp.id(352213310244138629)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352214246302138630)
,p_plug_template_id=>wwv_flow_imp.id(352213310244138629)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352214517958138630)
,p_plug_template_id=>wwv_flow_imp.id(352213310244138629)
,p_name=>'Sub Regions'
