...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352219068024138633)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352219368672138633)
,p_plug_template_id=>wwv_flow_imp.id(352219068024138633)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352219679315138634)
,p_plug_template_id=>wwv_flow_imp.id(352219068024138633)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352219906976138634)
,p_plug_template_id=>wwv_flow_imp.id(352219068024138633)
,p_name=>'Sub Regions'
