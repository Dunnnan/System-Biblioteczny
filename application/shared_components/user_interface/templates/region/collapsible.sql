...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352230862757138642)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352231193255138642)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352231402597138642)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352231712048138642)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352232078852138643)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352232321171138643)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352232601653138643)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352232933416138643)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352233249407138644)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352233532435138644)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352233888205138644)
,p_plug_template_id=>wwv_flow_imp.id(352230862757138642)
,p_name=>'Sub Regions'
