...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352240615533138649)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352240929324138650)
,p_plug_template_id=>wwv_flow_imp.id(352240615533138649)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352241271742138650)
,p_plug_template_id=>wwv_flow_imp.id(352240615533138649)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352241549475138650)
,p_plug_template_id=>wwv_flow_imp.id(352240615533138649)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352241821591138650)
,p_plug_template_id=>wwv_flow_imp.id(352240615533138649)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352242172896138650)
,p_plug_template_id=>wwv_flow_imp.id(352240615533138649)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352242414432138651)
,p_plug_template_id=>wwv_flow_imp.id(352240615533138649)
,p_name=>'Sub Regions'
