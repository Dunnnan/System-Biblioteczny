...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352245239672138653)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352245583952138653)
,p_plug_template_id=>wwv_flow_imp.id(352245239672138653)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352245803710138653)
,p_plug_template_id=>wwv_flow_imp.id(352245239672138653)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352246123740138653)
,p_plug_template_id=>wwv_flow_imp.id(352245239672138653)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352246451096138654)
,p_plug_template_id=>wwv_flow_imp.id(352245239672138653)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352246747205138654)
,p_plug_template_id=>wwv_flow_imp.id(352245239672138653)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
