...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352248707261138655)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352249001384138656)
,p_plug_template_id=>wwv_flow_imp.id(352248707261138655)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352249344369138656)
,p_plug_template_id=>wwv_flow_imp.id(352248707261138655)
,p_name=>'Sub Regions'
