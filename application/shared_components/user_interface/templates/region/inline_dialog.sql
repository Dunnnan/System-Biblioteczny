...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352254161947138659)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352254432553138660)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352254721186138660)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352255066114138660)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352255399096138660)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352255690932138660)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352255945836138661)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352256225793138661)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352256550728138661)
,p_plug_template_id=>wwv_flow_imp.id(352254161947138659)
,p_name=>'Sub Regions'
