...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352258726004138663)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352259022415138663)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352259311525138663)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352259632564138663)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352259919003138663)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352260297181138664)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352260550851138664)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352260854827138664)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352261165519138664)
,p_plug_template_id=>wwv_flow_imp.id(352258726004138663)
,p_name=>'Sub Regions'
