...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352263398612138666)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352263642742138666)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352263929868138666)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352264249510138667)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352264541642138667)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352264833303138667)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352265147415138667)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352265406755138667)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352265793618138668)
,p_plug_template_id=>wwv_flow_imp.id(352263398612138666)
,p_name=>'Sub Regions'
