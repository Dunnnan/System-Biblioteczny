...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352268768448138670)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352269014030138671)
,p_plug_template_id=>wwv_flow_imp.id(352268768448138670)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352269316446138671)
,p_plug_template_id=>wwv_flow_imp.id(352268768448138670)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352269658036138671)
,p_plug_template_id=>wwv_flow_imp.id(352268768448138670)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352269972158138671)
,p_plug_template_id=>wwv_flow_imp.id(352268768448138670)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352270225041138671)
,p_plug_template_id=>wwv_flow_imp.id(352268768448138670)
,p_name=>'Sub Regions'
