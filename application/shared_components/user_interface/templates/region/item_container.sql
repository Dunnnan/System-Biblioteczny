...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352270830333138672)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352271142317138672)
,p_plug_template_id=>wwv_flow_imp.id(352270830333138672)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352271411550138672)
,p_plug_template_id=>wwv_flow_imp.id(352270830333138672)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352271744071138672)
,p_plug_template_id=>wwv_flow_imp.id(352270830333138672)
,p_name=>'Button Start'
