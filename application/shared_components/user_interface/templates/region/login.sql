...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352273391007138674)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352273682038138674)
,p_plug_template_id=>wwv_flow_imp.id(352273391007138674)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352273912985138674)
,p_plug_template_id=>wwv_flow_imp.id(352273391007138674)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352274278146138674)
,p_plug_template_id=>wwv_flow_imp.id(352273391007138674)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352274519037138675)
,p_plug_template_id=>wwv_flow_imp.id(352273391007138674)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352274838553138675)
,p_plug_template_id=>wwv_flow_imp.id(352273391007138674)
,p_name=>'Sub Regions'
