...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352275833791138676)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352276163418138676)
,p_plug_template_id=>wwv_flow_imp.id(352275833791138676)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352276484630138676)
,p_plug_template_id=>wwv_flow_imp.id(352275833791138676)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352276741886138676)
,p_plug_template_id=>wwv_flow_imp.id(352275833791138676)
,p_name=>'Sub Regions'
