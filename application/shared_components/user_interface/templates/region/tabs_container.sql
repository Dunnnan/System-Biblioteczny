...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352288387479138685)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352288609653138685)
,p_plug_template_id=>wwv_flow_imp.id(352288387479138685)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352288933194138685)
,p_plug_template_id=>wwv_flow_imp.id(352288387479138685)
,p_name=>'Tabs'
