...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352290986886138687)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352291213892138687)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352291582802138687)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352291803085138687)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352292127572138687)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352292489123138688)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352292790532138688)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352293094044138688)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352293362356138688)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352293606235138688)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352293958438138689)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352294213551138689)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352294512051138689)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352294836607138689)
,p_plug_template_id=>wwv_flow_imp.id(352290986886138687)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
