...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(352296055754138690)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352296316139138690)
,p_plug_template_id=>wwv_flow_imp.id(352296055754138690)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352296671185138691)
,p_plug_template_id=>wwv_flow_imp.id(352296055754138690)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352296967523138691)
,p_plug_template_id=>wwv_flow_imp.id(352296055754138690)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352297270537138692)
,p_plug_template_id=>wwv_flow_imp.id(352296055754138690)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(352297588411138692)
,p_plug_template_id=>wwv_flow_imp.id(352296055754138690)
